...
/**
 * Class ImportantNote
 * @package WeltPixel\LayeredNavigation\Block\Adminhtml\System\Config
 */
class ImportantNote extends \Magento\Config\Block\System\Config\Form\Field
{
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        $html = '<div class="importany-note">'
            ...
            . '<p>Head over to the Product Page and <a href="https://www.weltpixel.com/improved-magento-2-layered-navigation-ajax-filter-multi-select-price-slider.html?quickview=pro" target="_blank">get your PRO version now!</a></p>'
            .  "</div>";
