...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    ...
    protected function _isElasticSearchEngine()
    {
        ...
        if ($currentEngine == 'elasticsearch' || $currentEngine == 'elasticsearch5'
            || $currentEngine == 'elasticsearch6' || $currentEngine == 'elasticsearch7' || $currentEngine == 'elasticsearch8' ) {
            return true;
        }
    ...
    protected function _isElasticOrOpenSearchEngine()
    {
        $currentEngine = $this->_scopeConfig->getValue(EngineInterface::CONFIG_ENGINE_PATH, ScopeInterface::SCOPE_STORE);
        if ($currentEngine == 'elasticsearch' || $currentEngine == 'elasticsearch5'
            || $currentEngine == 'elasticsearch6' || $currentEngine == 'elasticsearch7' || $currentEngine == 'opensearch' ) {
            return true;
        }
